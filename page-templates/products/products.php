...
<div class="content">
    <div class="top-inner-page-btn">
        ...
        <a  href="<?= site_url() ?>/admin/products/product-create" class="text-white top-inner-page-btn">اضف جديد &nbsp; +</a>
    ...
    <div class="d-flex align-items-center justify-content-between mt-4 flex-wrap">
        <div class="dropdown">
            <button class="btn btn-drop dropdown-toggle text-white" dir="rtl" type="button" id="dropdownMenuButton1"
                data-bs-toggle="dropdown" aria-expanded="false">فرز
                نشرت 10
        ...
        <div class="d-flex flex-wrap">
            <div class="top-dropdown">
                <div class="dropdown">
                    <button class="btn btn-drop dropdown-toggle" type="button" id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" aria-expanded="false"> <i class="fa fa-chevron-down ms-2"
                            style="font-size: 12px; color: white;"></i>حدد العلامة</button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#">Action</a></li>
                        <li><a class="dropdown-item" href="#">Another action</a></li>
                    </ul>
            ...
            <div class="top-dropdown">
                <div class="dropdown">
                    <button class="btn btn-drop dropdown-toggle" type="button" id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" aria-expanded="false"> <i class="fa fa-chevron-down ms-2"
                            style="font-size: 12px; color: white;"></i>اختر الفئة</button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#">Action</a></li>
                        <li><a class="dropdown-item" href="#">Another action</a></li>
                    </ul>
            ...
            <div class="top-dropdown">
                <div class="dropdown">
                    <button class="btn btn-drop dropdown-toggle" type="button" id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" aria-expanded="false"> <i class="fa fa-chevron-down ms-2"
                            style="font-size: 12px; color: white;"></i>وضع مخزون</button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#">Action</a></li>
                        <li><a class="dropdown-item" href="#">Another action</a></li>
                    </ul>
                    ...
                    <thead>
                        <tr class="first-row">
                            <th scope="col" class="text-end pe-2" dir="ltr">اسم المنتج
                                <img class="isam-image ms-2"
                                    src="<?php echo $plugin_url ?>includes/assets/img/product-gallery-img.png"
                                    style="width: 30px; height: 30px;" alt="">
                                <input class="form-check-input" style="margin-top: 2px;" type="checkbox" value=""
                                    id="flexCheckDefault">
                            </th>
                            <th scope="col">SKU</th>
                          ...
                          // die();
                            ...
                            <tr class="text-white">
                                <td class="text-end" dir="ltr">
                                    <?= $title ?>
                                    <a
                                        href="<?php echo home_url('/admin/products/edit-product/?product_id=' . $product->ID); ?>">
